          ...
          <div className="prose max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                By accessing or using ConnectAfrik, you agree to be bound by these Terms of Service and all applicable 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Permission is granted to temporarily access ConnectAfrik for personal, non-commercial use. This is the grant 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                You retain ownership of any content you post on ConnectAfrik. By posting content, you grant us a worldwide, 
                non-exclusive, royalty-free license to use, reproduce, and distribute your content on the platform.
              </p>
              <p className="text-gray-700">
                You are solely responsible for your content and agree not to post content that violates any laws or the 
                rights of others.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">
                ConnectAfrik is provided "as is" without warranties of any kind, either express or implied. We do not warrant 
