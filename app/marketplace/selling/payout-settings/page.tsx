        ...
        <div className="flex gap-1 mb-6 p-1 bg-gray-100 rounded-lg overflow-x-auto">
          ...
          {tabs.map((tab) => (
            ...
            <button
              ...
              className={`flex-1 min-w-[120px] flex items-center justify-center gap-2 px-3 py-2.5 rounded-md text-sm font-medium transition-colors whitespace-nowrap ${activeTab === tab.id
