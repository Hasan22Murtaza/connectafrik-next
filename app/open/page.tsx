 ...
 *
 * Security: the target is validated against an allowlist; anything not on the
 * allowlist falls back to /feed.
 */
export default async function OpenPage({
  ...
  const target = normalizeTarget(params.target ?? null) ?? '/feed'
