...
const mockAds: AdData[] = [
  ...
  {
    id: '2',
    title: 'Discover Global Fashion',
    description: 'Shop clothing and accessories from independent designers and creators around the world.',
    imageUrl: '/assets/images/odin.png',
  ...
  },
  {
    ...
    description: 'Connect across cultures through language. Start learning today with free lessons.',
    imageUrl: '/assets/images/odin.png',
    clickUrl: 'https://www.duolingo.com/',
    advertiser: 'WorldLanguages',
    cta: 'Start Learning'
  },
  {
    id: '4',
    title: 'Invest in Emerging Startups',
    description: 'Support the next generation of entrepreneurs worldwide and grow with innovative ideas.',
    imageUrl: '/assets/images/odin.png',
