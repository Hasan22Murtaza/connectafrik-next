...
const NotificationDropdown: React.FC<NotificationDropdownProps> = ({ isOpen, onClose, onUnreadCountChange }) => {
  ...
  return (
    <div className="absolute sm:right-0 -right-6 mt-2 w-56 sm:w-80 max-w-[90vw] bg-surface-elevated rounded-lg shadow-dropdown border border-border z-[120] overflow-hidden">
      <div ref={dropdownRef}>
        <div className="flex items-center justify-between p-3 sm:p-4 border-b border-border">
          <h3 className="text-base sm:text-lg font-semibold text-content">Notifications</h3>
        ...
        >
          {loading ? (
            <div className="p-3 sm:p-4 text-center text-content-secondary">
              Loading notifications...
            </div>
          ) : notifications.length === 0 ? (
            <div className="p-6 sm:p-8 text-center">
              <Bell className="w-12 h-12 text-content-tertiary mx-auto mb-3" />
              <p className="text-content-secondary font-medium">No notifications</p>
              <p className="text-sm text-content-tertiary mt-1">You're all caught up!</p>
            </div>
          ) : (
            <div className="divide-y divide-border-subtle">
                ...
                >
                  <div className="flex items-start space-x-2 sm:space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-content-secondary mt-1 break-words overflow-hidden">
              ...
              {loadingMore && (
                <div className="p-3 text-center text-xs text-content-secondary">Loading more...</div>
              )}
              {!hasMore && notifications.length >= PAGE_SIZE && (
                <div className="p-3 text-center text-xs text-content-tertiary">No more notifications</div>
              )}
            </div>
          )}
        </div>
