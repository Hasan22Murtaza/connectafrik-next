...
const NotificationDropdown: React.FC<NotificationDropdownProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="absolute right-0 mt-2 w-72 sm:w-80 max-w-[90vw] sm:max-w-[90vw] bg-white rounded-lg shadow-lg border border-gray-200 z-[120] transform -translate-x-0 sm:translate-x-0">
      <div ref={dropdownRef}>
        {/* Header */}
