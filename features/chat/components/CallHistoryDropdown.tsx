            ...
            <div className="space-y-1 sm:space-y-2">
              {sortedRecentCalls.map(call => {
                ...
                return (
                  <div
                    key={call.session_id}
                    className="group flex items-center justify-between rounded-lg hover:bg-primary-50 p-2 transition-colors"
                  >
                    <div className="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1">
                      ...
                      <div className="min-w-0 flex-1">
                        <p className={`text-sm font-semibold truncate group-hover:text-orange-700 ${missed ? 'text-red-600' : 'text-content'}`}>
                          {call.name}
                        </p>
