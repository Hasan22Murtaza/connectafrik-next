...
export function MemoriesVerticalFeed({
  ...
  if (loading && reels.length === 0) {
    return (
      <div className="flex min-h-[calc(100dvh-3.5rem)] flex-col items-center justify-center  text-white lg:min-h-[calc(100dvh-4.5rem)] lg: lg:text-content">
        <div
  ...
  if (error) {
    return (
      <div className="flex min-h-[calc(100dvh-3.5rem)] flex-col items-center justify-center  px-6 text-center text-white lg:min-h-[calc(100dvh-4.5rem)] lg: lg:text-content">
  ...
  if (reels.length === 0) {
    return (
      <div className="fixed inset-0 z-40 flex flex-col items-center justify-center  px-6 pb-10 pt-16 text-center text-white lg:static lg:z-auto lg:min-h-[calc(100dvh-4.5rem)] lg: lg:pb-6 lg:pt-0 lg:text-content">
  ...
  return (
    <>
      <div className="fixed inset-0 z-40  lg:static lg:z-auto lg:min-h-[calc(100dvh-4.5rem)] lg:">
        <div className="fixed bottom-0 left-0 right-0 z-[46] border-t border-white/10 bg-black/90 px-2 pb-[calc(0.4rem+env(safe-area-inset-bottom))] pt-1 text-white lg:hidden">
          <div className="mx-auto max-w-lg">
            <MemoriesNav variant="video-bottom" />
          </div>
