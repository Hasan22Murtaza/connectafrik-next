    ...
    <div className="min-h-[calc(100dvh-4.5rem)] bg-surface-canvas pb-[calc(5.25rem+env(safe-area-inset-bottom))] lg:pb-6">
      ...
      {loading && reels.length === 0 ? (
        <div className="flex min-h-[calc(100dvh-8.5rem)] items-center justify-center lg:min-h-[calc(100dvh-10rem)]">
          <div className="h-10 w-10 animate-spin rounded-full border-2 border-border border-t-primary-600" />
        </div>
      ) : reels.length === 0 ? (
        <div className="flex min-h-[calc(100dvh-8.5rem)] flex-col items-center justify-center px-6 text-center lg:min-h-[calc(100dvh-10rem)]">
          <p className="text-sm text-content-secondary">No memories in this category yet.</p>
